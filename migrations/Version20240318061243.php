 ...
 */
final class Version20240318061243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE region ADD hiking_id INT DEFAULT NULL, ADD hik_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE region DROP hiking_id, DROP hik_id');
    }
}
